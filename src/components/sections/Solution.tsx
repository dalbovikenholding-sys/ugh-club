      ...
      <div className="max-w-5xl mx-auto px-6 py-24">
        <div className="grid gap-16 lg:grid-cols-2 items-center">
          <div>
            ...
            <h2 className="font-serif italic text-white/95 mb-5" style={{ fontSize: 'clamp(28px, 3.5vw, 48px)' }}>
            ...
            <div className="flex flex-col gap-3">
              {benefits.map((b) => (
                ...
                >
                  ...
                  <span className="font-sans text-white/80 text-sm">{b}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          >
            <p className="font-sans text-[10px] tracking-[0.22em] uppercase text-white/40 mb-3">
              Vad ingår
            </p>
            ...
            <div className="flex flex-col gap-4">
              {included.map((item) => (
                <div key={item} className="flex items-center gap-3">
                  <span className="text-[#a8c4e8] text-sm flex-shrink-0">→</span>
                  <span className="font-sans text-white/75 text-sm">{item}</span>
                </div>
              ))}
            </div>
          </div>
